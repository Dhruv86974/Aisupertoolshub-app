...
const LOCALIZED_PROFILE: Record<LanguageCode, {
  ...
  pt: {
    ...
    emailLabel: "Endereço de E-mail (Apenas leitura)",
    ...
    tierLabel: "Nível de Assinatura",
    creditsLabel: "Créditos Restantes",
    unlimited: "Ilimitado (Empresa Ativa)",
    activeTier: "Passe Ativo",
    statsTitle: "Suas Estatísticas de Uso de IA",
    interactiveCalls: "Total de Computações de IA"
  },
  ar: {
    title: "إعدادات الملف الشخصي",
    editTab: "تعديل الملف الشخصi",
    passwordTab: "تغيير كلمة المرور",
    nameLabel: "الاسم الكامل",
    usernameLabel: "اسم المستخدم",
    emailLabel: "البريد الإلكتروني (للقراءة فقط)",
    ...
    successPasswordUpdate: "تم تغيير كلمة المرور بنجاح!",
    passwordMismatch: "كلمات المرور الجديدة غير متطابقة!",
    tierLabel: "فئة الاشتراك",
    creditsLabel: "الرصيد المتبقي",
    unlimited: "غير محدود (نشط للمؤسسات)",
    activeTier: "البطاقة النشطة",
    statsTitle: "إحصائيات استخدام الذكاء الاصطناعي الخاص بك",
    interactiveCalls: "إجمالي عمليات الحساب للذكاء الاصطناعي"
  }
};
