...
const LOCALIZED_AUTH: Record<LanguageCode, {
  ...
  pt: {
    ...
    loginBtn: "Acessar Plataforma",
    signupBtn: "Registrar & Iniciar",
    orText: "OU CONECTE INSTANTANEAMENTE",
    demoBtn: "Entrada de Demonstração em 1 Clique ⚡",
    haveAccount: "Já tem uma conta? Entrar",
    noAccount: "Novo no AI Hub? Criar Conta",
    emailRequired: "Insira um endereço de e-mail válido",
    passwordRequired: "A senha deve ter pelo menos 6 caracteres",
    ...
    brandTagline: "Acesse mais de 25 mecanismos de automação de IA premium, rastreadores de produtividade diários e fluxos de trabalho inteligentes.",
    securityNotice: "Criptografia SSL Padrão Ativa",
    googleBtn: "Conta do Google",
    facebookBtn: "Login com Facebook",
    selectAccountTitle: "Selecione Conta Social para Conectar",
    anotherAccountBtn: "Usar conta social personalizada",
    enterEmailPlaceholder: "Insira o e-mail da conta social",
    enterNamePlaceholder: "Insira seu nome completo"
  },
  ar: {
    ...
    signupBtn: "تسجيل وتشغيل",
    orText: "أو اتصل فوراً",
    demoBtn: "دخول تجريبي بضغطة واحدة ⚡",
    haveAccount: "هل لديك حساب بالفعل؟ تسجيل الدخول",
    noAccount: "جديد في AI Hub؟ أنشئ حسابك",
    ...
    brandTagline: "الوصول إلى أكثر من 25 محرك ذكاء اصطناعي متميز، ومتتبعات إنتاجية يومية، وسير عمل ذكي في مكان واحد.",
    securityNotice: "تشفير SSL القياسي نشط",
    googleBtn: "حساب Google",
    facebookBtn: "تسجيل الدخول بـ Facebook",
    selectAccountTitle: "اختر الحساب الاجتماعي للاتصال",
    anotherAccountBtn: "استخدم حساباً اجتماعياً مخصصاً",
    enterEmailPlaceholder: "أدخل بريد حسابك الاجتماعي",
    enterNamePlaceholder: "أدخل اسمك الكامل"
  }
};
